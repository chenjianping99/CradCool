...
class HighlightView
{
	...
	/**
	 * 设置裁剪区域表示缩放的箭头图标
	 * @param resizeDrawableWidth		水平方向的箭头图标，可以为null
	 * @param resizeDrawableHeight		垂直方向的箭头图标，可以为null
	 * @param resizeDrawableDiagonal	对角方向的箭头图标，可以为null
	 */
	public void setResizeDrawable(Drawable resizeDrawableWidth, Drawable resizeDrawableHeight,
			Drawable resizeDrawableDiagonal)
	{
		mResizeDrawableWidth = resizeDrawableWidth;
		mResizeDrawableHeight = resizeDrawableHeight;
		mResizeDrawableDiagonal = resizeDrawableDiagonal;
			...
			if (mMode == ModifyMode.Grow)
			{
				...
				else
				{
					if (mResizeDrawableWidth != null && mResizeDrawableHeight != null)
					{
						...
						mResizeDrawableWidth.setBounds(left - widthWidth, yMiddle - widthHeight,
								left + widthWidth, yMiddle + widthHeight);
						mResizeDrawableWidth.draw(canvas);

						mResizeDrawableWidth.setBounds(right - widthWidth, yMiddle - widthHeight,
								right + widthWidth, yMiddle + widthHeight);
						mResizeDrawableWidth.draw(canvas);
						...
						mResizeDrawableHeight.setBounds(xMiddle - heightWidth, bottom
								- heightHeight, xMiddle + heightWidth, bottom + heightHeight);
						mResizeDrawableHeight.draw(canvas);
					}
				}
			}
