package com.jiubang.goscreenlock.theme.cjpcardcool.viewHelper;

import static com.jiubang.goscreenlock.theme.cjpcardcool.viewHelper.AnimatorProxy.NEEDS_PROXY;
import static com.jiubang.goscreenlock.theme.cjpcardcool.viewHelper.AnimatorProxy.wrap;
import android.view.View;
/**
 * @author xule 处理3.0版本以下不能使用部分动画，设置透明度效果
 * 
 */
